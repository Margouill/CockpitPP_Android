package fr.margouill.cockpitpp.services;
...
import fr.margouill.cockpitpp.MyApp;
                        ...
                        if (messageArray[0].equals(getString(R.string.HeadKey))) {//Check if it is from Cockpit++.lua
                            if(MyApp.LUA_VERSION.equals(messageArray[1])) {//Check the version of the Cockpit++.lua, to know if the versions are good of if the user needs to update the Application or the Lua
                                ...
                                if(messageArray[2].equals(getString(R.string.m2kc)) && messageArray.length > 11) {
                                    ...
                                    //sendBroadcast(new Intent().setAction(BroadcastKeys.M2KC_VUHF).putExtra(BroadcastKeys.M2KC_VUHF,messageArray[13]));
                                ...
                                } else if (messageArray[2].equals(getString(R.string.ka50)) && messageArray.length > 3) {
                                    //Log.d("UDP", "Received: =" + messageArray[3]);
                                    //Log.d("UDP", "Received: =" + messageArray[5]);


                                    sendBroadcast(new Intent().setAction(BroadcastKeys.KA50_PUI800).putExtra(BroadcastKeys.KA50_PUI800,messageArray[3]));
                                    sendBroadcast(new Intent().setAction(BroadcastKeys.KA50_OVERHEAD).putExtra(BroadcastKeys.KA50_OVERHEAD,messageArray[4]));
                                    sendBroadcast(new Intent().setAction(BroadcastKeys.KA50_UV26).putExtra(BroadcastKeys.KA50_UV26,messageArray[5]));
                                    sendBroadcast(new Intent().setAction(BroadcastKeys.KA50_PRTZ).putExtra(BroadcastKeys.KA50_PRTZ,messageArray[6]));
                                    sendBroadcast(new Intent().setAction(BroadcastKeys.KA50_LWR).putExtra(BroadcastKeys.KA50_LWR,messageArray[7]));
                                    //sendBroadcast(new Intent().setAction(BroadcastKeys.KA50_EKRAN).putExtra(BroadcastKeys.KA50_EKRAN,messageArray[8]));
