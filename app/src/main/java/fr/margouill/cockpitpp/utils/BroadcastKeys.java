package fr.margouill.cockpitpp.utils;

/**
 * Created by margouill on 29/04/2017.
...
public class BroadcastKeys {
    ...
    /** Broadcast keys for the Ka-50 **/
    public static final String KA50_PUI800 = "Ka50_PUI800_panel";
    public static final String KA50_OVERHEAD = "Ka50_Overhead_panel";
    public static final String KA50_UV26 = "Ka50_UV26_panel";
    public static final String KA50_LWR = "Ka50_LWR_panel";
    public static final String KA50_PRTZ = "Ka50_PRTz_panel";
    public static final String KA50_EKRAN = "Ka50_PRTz_panel";
